...
do
	...
	sudo echo "br0 ip:"$br0_ip >> /home/gisled/.ledclient_network.log

	if [[ $br0_ip == 192.168.0.* ]];then
		sudo echo "Abr0 ip:"$br0_ip >> /home/gisled/.ledclient_network.log
		sudo ledclient -fflags nobuffer udp://239.11.11.11:15000
		sleep 1
